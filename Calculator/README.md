...
- **Interactive display:** Shows calculation history and current value, formatting numbers with thousands separators.
- **Calculator operations:** Supports number entry, decimal handling, clear/all-clear, sign inversion, percent, binary operators (add, subtract, multiply, divide), chained operations, and division-by-zero protection.
